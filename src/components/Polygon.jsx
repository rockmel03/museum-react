...
const Polygon = () => {
  ...
  return (
    <section className="w-full md:min-h-screen py-[10vh] md:py-[20vh] flex flex-col items-center justify-center">
      <div
        style={{
          clipPath:
            "polygon(0px 0px, 100% 0px, 58.0181% 70%, 58.0181% 100%, 41.9819% 100%, 41.9819% 70%)",
        }}
        className="clip md:w-[58%] md:h-[70vh] overflow-hidden mb-10 md:mb-24"
      >
        <img
          src="/img1.webp"
          alt=""
      ...
      <h1 className=" text-2xl md:text-5xl font-serif">Share</h1>
    </section>
  );
};
